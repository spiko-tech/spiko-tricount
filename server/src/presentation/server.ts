...
import { DatabaseLive, MigratorLive, SqlTricountRepositoryLive } from '../infrastructure/index.js';
import { HealthApiGroupLive } from './health.js';
import { TricountsApiGroupLive } from './tricounts.js';

const ApiLive = HttpApiBuilder.api(Api).pipe(Layer.provide(HealthApiGroupLive), Layer.provide(TricountsApiGroupLive));
